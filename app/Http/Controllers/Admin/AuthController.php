...
//            $role->users()->attach($user);
            if (!$activate) {
                ...
                return redirect('admin.login')->with('success', trans('Your account has been created successfully. Before proceeding activate your account'));
            }
...
//            return "asdad";
        ...
        return back()->with('success', trans('Success: Password recovery email successfully sent.'));
    }
