    ...
    public function data()
    {
        ...
        return DataTables::of($news)
            ...
            ->addColumn('actions', function ($user) {
                ...
                $actions .= '<a href=' . route('admin.news.confirm-delete', $user->id) . ' data-id="'.$user->id.'" data-toggle="modal" data-target="#delete_confirm"><i class="livicon" data-name="trash" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete News"></i></a>';
