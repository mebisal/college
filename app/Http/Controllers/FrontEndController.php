...
//            $role = Sentinel::findRoleBySlug('user');
            ...
            if (!$activate) {
                ...
                return redirect('login')->with('success', trans('Your account has been created successfully. Before proceeding activate your account'));
            }
...
//            return "asdad";
        ...
        return  Redirect::route('login')->with('success', trans('Success: Password recovery email successfully sent.'));
    }
