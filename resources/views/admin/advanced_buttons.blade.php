    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-12 my-3">
                            ...
                            <ul>
                                <li>
                                            <span class="button-wrap">
                                                <a href="#" class="button button-circle button-large btn1">Button</a>
                                            </span>
                                </li>
                                <li>
                                            <span class="button-wrap">
                                ...
                                <li>
                                            <span class="button-wrap">
                                                <a href="#" class="button button-pill btn1">Button</a>
                                            </span>
                                </li>
                                <li>
                                            <span class="button-wrap">
                ...
                <div class="card panel-danger my-3">
                    ...
                    <div class="card-body">
                        <div class="flatbuttons_small1">
                            <a href="#" class="button button-block button-rounded button-large btn1">Button</a>
                            <br/>
                ...
                <div class="card  panel-default my-3">
                    <div class="card-heading">
                        <h3 class="card-title">
                    ...
                    <div class="card-body social_icons">
                        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-12 my-3">
                            ...
                            <ul>
                                <li>
                                    <div class="button-group">
                                        <button type="button" class="button animate_rtl">Option 1</button>
                                        <button type="button" class="button animate_rtl">Option 2</button>
                                        <button type="button" class="button">Option 3</button>
                                    </div>
                                </li>
                                <li>
                                    <div class="button-group">
                                        <button type="button" class="button button-primary animate_rtl">Option 1</button>
                                        <button type="button" class="button button-primary animate_rtl">Option 2</button>
                                        <button type="button" class="button button-primary">Option 3</button>
                                    </div>
                                </li>
                                <li>
                                    <div class="button-group success_btn">
                                        <button type="button" class="button button-pill button-success animate_rtl">Option 1</button>
                                        <button type="button" class="button button-pill button-success animate_rtl">Option 2</button>
                                        <button type="button" class="button button-pill button-success">Option 3</button>
                                    </div>
                                </li>
                                <li>
                                    <div class="button-group">
                                        <button type="button" class="button button-flat-primary animate_rtl">Option 1</button>
                                        <button type="button" class="button button-flat-primary animate_rtl">Option 2</button>
                ...
                <div class="card panel-info my-3">
                    ...
                    <div class="card-body grp_btn">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="ui-group-buttons">
                                    <a href="#" class="btn btn-success animate_rtl" role="button">
                                        <span class="livicon" data-name="thumbs-up" data-size="18" data-loop="true" data-c="#fff" data-hc="white"></span>
                                    </a>
                                    <div class="or animate_rtl"></div>
                                ...
                                <br/>
                                <div class="ui-group-buttons">
                                    <button type="button" class="btn btn-primary btn-lg animate_rtl">Large button</button>
                                    <div class="or or-lg animate_rtl"></div>
                                    <button type="button" class="btn btn-success btn-lg">Large button</button>
                                </div>
                                <br/>
                                <br/>
                                <div class="ui-group-buttons">
                                    <button type="button" class="btn btn-primary animate_rtl">Default</button>
                                    <div class="or or-primary animate_rtl"></div>
                                    <button type="button" class="btn btn-success">Success</button>
                                </div>
                                <br/>
                                <br/>
                                <div class="ui-group-buttons">
                                    <button type="button" class="btn btn-primary btn-sm animate_rtl">Small button</button>
                                    <div class="or or-sm animate_rtl"></div>
                ...
                <div class="card panel-warning">
                    ...
                    <div class="card-body icon-buttons">
                        <h2>Cool Buttons With Labels</h2>
                        <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 col-sm-6 buttons_labels">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                            ...
                            <br/>
                            <a class="btn btn-success  btn btn-labeled" role="button">
                                        <span class="btn-label pull-left">
