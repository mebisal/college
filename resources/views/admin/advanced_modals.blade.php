    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-12 my-3">
                <div class="card panel-primary customized">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 ">
                                ...
                                <br>
                                <button class="btn btn-raised btn-primary dir_txt" data-toggle="modal" data-target="#modal-2">
                                    Slide in (right)
                                </button>
                                <button class="btn btn-raised btn-primary dir_txt" data-toggle="modal" data-target="#modal-3">
                                    Slide in (bottom)
                                </button>
                            </div>
                            <div class="col-md-3">
