...
<!--section ends-->
<section class="content dropdownspage">
    <!--main content-->
    <div class="row">
        <div class="col-md-12 col-sm-6 col-lg-6 col-12 ">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-append radius_left">
                            ...
                            <div class="input-group-append">
                                ...
                                <span id="border_radius1" class="input-group-text border_radius"><span class="fa fa-search"></span></span>
                                <!--</button>-->
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group select2-bootstrap-prepend dropdowns-select-prepend">
                                        <div class="input-group-prepend">
                                            <button class="btn btn-default input-group-text remove_radius_right" type="button"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group select2-bootstrap-append dropdowns-select-multiappend ">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-default remove_radius" type="button" data-select2-open="multi-append">
                                    <span class="fa fa-search"></span>
                                </button>
                                <button class="btn btn-default remove_radius" type="button" data-select2-open="multi-prepend">State
                                </button>
            ...
            <div class="card panel-warning m-b-50 my-3">
                <div class="card-heading">
                    <h3 class="card-title">
