...
@section('header_styles')
    ...
    <link href="{{ asset('assets/css/bootstrap-wysihtml5-rtl.css') }}" rel="stylesheet" type="text/css"/>
        ...
        <div class="row">
                        <div class="col-12">
                            <div class="card panel-primary my-3">
                                ...
                                <div class="card-body panel_bgcolor editor_summer">
                    ...
                    <div class="row my-3">
                        <div class="col-12">
                            <div class="card panel-success my-3">
                                ...
                                <div class="card-body panel_bgcolor panel_space">
                                    <div class="bootstrap-admin-panel-content">
