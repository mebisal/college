            ...
            <section class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 my-2">
                                    ...
                                    <div> <b class="margin_right15"> {{$min_id}} </b>
                                        ...
                                        <input id="ex8" type="text" data-slider-id='ex1Slider' class="slider form-control" data-slider-handle="square" value="" data-slider-min="{{$min_id}}" data-slider-max="{{$max_id}}" data-slider-step="1" data-slider-value="[{{$min_id}},{{$max_id}}]" data-slider-tooltip="show"/> <b class="margin_left15" style="margin-left: 15px;">@if(!empty($max_count)){{$max_id}} @else 10 @endif</b>
                ...
                <div class="row my-3">
                    <div class="col-lg-12">
                        <div class="card panel-primary filterable">
                            <div class="card-heading clearfix" >
                                <div class="card-title pull-left animate_rtl">
                            ...
                            <div class="card panel-primary filterable">
                                ...
                                <div class="row paddng my-2">
                                    <div class="col-md-4">
                                        ...
                                        <div> <b class="margin_right15">{{$min_id}}</b>
                                            <input id="id_range2" type="text" data-slider-id='id_range' class="slider form-control" dusk="slide_range" data-slider-handle="square" value="" data-slider-min="{{$min_id}}" data-slider-max="{{$max_id}}" data-slider-step="1" data-slider-value="[{{$min_id}},{{$max_id}}]"/> <b class="margin_left15" style="margin-left: 15px;">@if(!empty($max_count)){{$max_id}} @else 10 @endif</b>
                                        </div>
                                    </div>
