...
@section('header_styles')
    ...
    <link href="{{ asset('assets/css/pages/sweetalert.css') }}" rel="stylesheet" type="text/css"/>
                ...
                <div class="card panel-danger table-edit">
                    ...
                    <div class="card-body">
                        ...
                        <div id="sample_editable_1_wrapper" class="">
                            ...
                            <table class="table table-striped table-responsive table-bordered table-hover dataTable no-footer sample_editable"
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/pages/sweetalert.dev.js') }}" type="text/javascript"></script>
