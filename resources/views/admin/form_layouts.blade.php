            ...
            <div class="col-xl-12">
                ...
                <div id="tab1" class="tab-pane fade  show active" role="tabpanel">
                        <div class="row my-3">
                                            ...
                                            <div class="form-position">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9 ml-auto">
                                                        ...
                                                        &nbsp;
                                                        <input type="reset" class="btn btn-default d-none d-lg-inline-block d-sm-inline-block d-md-inline-block" value="Reset">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                    <span class="input-group-append">
                                                                       <span class="input-group-text"><i class="livicon" data-name="mail" data-size="18" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                    </span>
                                                                        </span>
                                                                <input type="text" placeholder="Email Address" class="form-control" id="inputEmail" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                    <span class="input-group-append">
                                                                       <span class="input-group-text"><i class="livicon" data-name="cellphone" data-size="18" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                    </span>
                                                                        </span>
                                                                <input type="text" placeholder="Phone Number" class="form-control" id="inputnumber" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                    <span class="input-group-append">
                                                                       <span class="input-group-text"><i class="livicon" data-name="doc-portrait" data-c="#000" data-hc="#000" data-size="18" data-loop="true"></i>
                                                                    </span>
                                                                        </span>
                            ...
                            <div class="col-xl-6 col-md-12 col-12 set_topmrgn">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                    <span class="input-group-append">
                                                                       <span class="input-group-text"><i class="livicon" data-name="user" data-size="18" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                    </span>
                                                                        </span>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" placeholder="Email Address" class="form-control"  id="inputEmail1"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="password" placeholder="Password" class="form-control" id="pswrd"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder=" Address" id="inputAddress1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-xl-12 col-12 col-md-12 my-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Username" id="inputUsernametb">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" placeholder="Email Address" class="form-control" id="inputEmailtb"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="password" placeholder="Password" class="form-control" id="pswrdtb"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" placeholder="Phone Number" class="form-control" id="inputnumbertb"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder=" Address" id="inputAddresstb">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-body my-3">
                                                    <div class="form-group mar-top">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Username" id="inputUsername12">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="Email Address" class="form-control" id="email12"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" placeholder="Password" class="form-control"  id="passwrd"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="Phone Number" class="form-control" id="phnenumber" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder=" Address" id="address_1">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" placeholder="Password" class="form-control" id="paswrdset"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="Phone Number" class="form-control"  id="numberset"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                ...
                <div id="tab3" class="tab-pane fade" role="tabpanel">
                    <div class="row my-3">
                        <div class="col-xl-12">
                            ...
                            <div class="card panel-warning my-3">
                                <div class="card-heading">
                                    <h3 class="card-title">
                                ...
                                <div class="card-body border">
                                    <form action="#"  enctype="multipart/form-data" class="form-horizontal form-bordered-row">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-3 control-label" for="form-text-input1">Text</label>
                                                <div class="col-md-6">
                                                    <input type="text" id="form-text-input1" name="example-text-input" class="form-control" placeholder="Text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group striped-col">
                                        ...
                                        <div class="form-group striped-col ">
                                            <div class="row">
                                                <label class="col-md-3  my-3 control-label" for="row-file-input">File</label>
                                                <div class="col-md-9 pad-top20">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-3 control-label my-3" for="row-file-multiple-input">Multiple File</label>
                                                <div class="col-md-9 pad-top20">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-6 col-12">
                                        ...
                                        <div class="card-body">
                                            <form class="form-inline" role="form">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control ml-2" id="inlinePassword" placeholder="Password">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                            <form class="form-inline" role="form">
                                                <div class="row my-3">
                                                    ...
                                                    <div class="col-md-4 login_btn_inline">
                                                    <button type="submit" class="btn btn-primary mar-top ml-2">Login</button>
                                                    </div>
                                    ...
                                    <div class="card panel-info">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="inputEmail" class="control-label col-6 col-sm-2 hidden-xs">Email</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="staticPassword" class="control-label col-6 col-sm-2 hidden-xs">Password</label>
                                    ...
                                    <div class="card panel-danger">
                                        ...
                                        <div class="card-body create_btn">
                                            <form>
                                                <div class="row">
                                                    <div class="col-12 col-md-6 col-sm-6 col-xl-6 btn_margin_top right_actn">
                                                        <div class="input-group">
                                                            <div class="input-group-btn ">
                                                                <button type="button" class="btn btn-info dropdown-toggle btn-radius" data-toggle="dropdown">
                                                                    Action
                                                    ...
                                                    <div class="col-12 col-md-6 col-sm-6 col-xl-6 btn_margin_top">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control">
                                                            <div class="input-group-btn">
                                                                <button type="button" class="btn btn-info btn-radius1 dropdown-toggle" data-toggle="dropdown">
                                                                    Action
                                            ...
                                            <hr>
                                            <form>
                                                <div class="input-group right_actn2">
                                                    <div class="input-group-btn">
                                                        <button type="button" class="btn btn-warning btn-radius dropdown-toggle" data-toggle="dropdown">
                                                            Action
                                                            <i class=" caret clr_caret"></i>
                                                        </button>
                                                        <ul class="dropdown-menu">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control">
                                                    <div class="input-group-btn">
                                                        <button type="button" class="btn btn-warning btn-radius1 dropdown-toggle" data-toggle="dropdown">
                                                            Action
                                                            <i class=" caret clr_caret"></i>
                                                        </button>
                                                        <ul class="dropdown-menu pull-right">
                                    ...
                                    <div class="card panel-info my-3">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label col-3" for="supportEmail">Email:</label>
                                                        <div class="col-9">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label col-3 d-none d-sm-inline-block" for="supportPassword">Password:</label>
                                                        <label class="control-label col-3 d-lg-none d-md-none d-sm-none" for="supportPassword">Pwd:</label>
                                                        <div class="col-9">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label col-3  d-none d-sm-inline-block" for="supportCPassword">Confirm Password:</label>
                                                        <label class="control-label col-3 d-lg-none d-md-none d-sm-none" for="supportCPassword">Confirm Pwd:</label>
                                                        <div class="col-9">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label col-3" for="phoneNumber">Phone:</label>
                                                        <div class="col-9">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label col-3" for="postalAddress">Address:</label>
                                                        <div class="col-9">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label class="control-label col-3" for="ZipCode">Zip Code:</label>
                                                        <div class="col-9">
                                ...
                                <div class="col-md-12 col-xl-6 col-12">
                                    <div class="card panel-success">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="inputEmail_1" class="control-label col-6 col-sm-2">Email</label>
                                                        <div class="col-12 col-sm-10">
                                                            <input type="email" class="form-control" id="inputEmail_1" placeholder="Email">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="inputPassword" class="control-label d-none d-sm-block col-2 col-sm-2">Password</label>
                                                        <label for="inputPassword" class="control-label  d-md-none d-lg-none d-sm-none col-2">Pwd</label>
                                                        <div class="col-12 col-sm-10">
                                    ...
                                    <div class="card panel-default">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <div class="col-6 col-sm-4 col-md-4 col-xl-4 btn_margin_top">
                                                        <div class="input-group input-group-lg">
                                                                        <span class="input-group-append">
                                                                        <span class=input-group-text><i class="livicon" data-name="user" data-size="20" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                        </span>
                                                                            </span>
                                                            <input type="text" class="form-control">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 col-sm-4 col-md-4 col-xl-4 btn_margin_top">
                                                        <div class="input-group">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text"><input type="radio" class="radio-blue">
                                                                    </span>
                                                            </div>
                                                            <input type="text" class="form-control">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6 col-sm-4 col-md-4 col-xl-4 btn_margin_top">
                                                        <div class="input-group input-group-sm">
                                                                        <span class="input-group-append">
                                                                        <span class="input-group-text"><i class="livicon" data-name="user" data-size="16" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                        </span>
                                                                            </span>
                                                            <input type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-4 col-md-4 col-xl-4 btn_margin_top">
                                                        <div class="input-group input-group-sm">
                                                                        <span class="input-group-append">
                                                                            <span class="input-group-text">
                                                                                <input type="checkbox" class="square-blue" /></span>
                                                    ...
                                                    <div class="col-6 col-sm-4 col-md-4 col-xl-4 btn_margin_top">
                                                        <div class="input-group input-group-sm">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text"><input type="radio" class="radio-blue"></span>
                                                            </div>
                                                            <input type="text" class="form-control">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card panel-danger my-3">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group has-success">
                                                    <div class="row">
                                                        <label class="col-12 control-label animate_rtl" for="inputSuccess">Username</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-warning">
                                                    <div class="row">
                                                        <label class="col-12 control-label animate_rtl" for="inputWarning">Password</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-error">
                                                    <div class="row">
                                                        <label class="col-12 control-label animate_rtl" for="inputError">Email</label>
                                                        <div class="col-12">
                                            ...
                                            <form class="form-horizontal">
                                                <div class="form-group has-success has-feedback">
                                                    <div class="row">
                                                        <label class="col-12 control-label animate_rtl" for="inputSuccess3">Username</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-warning has-feedback">
                                                    <div class="row">
                                                        <label class="col-12 control-label animate_rtl" for="inputWarning2">Password</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-error has-feedback">
                                                    <div class="row">
                                                        <label class="col-12 control-label animate_rtl" for="inputError2">Email</label>
                                                        <div class="col-12">
                                    ...
                                    <div class="card panel-info">
                                        ...
                                        <div class="card-body">
                                            <form role="form" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                        <span class="input-group-append">
                                                                            <span class="input-group-text "><i class="livicon" data-name="key" data-size="18" data-c="#000" data-hc="#000" data-loop="true"></i>
                                                                                </span>
                                                                        </span>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group input-icon right">
                                                                        <span class="input-group-append">
                                                                           <span class="input-group-text"> <i class="livicon" data-name="mail" data-size="18" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i>
                                                                        </span>
                                                                            </span>
                                                ...
                                                <div class="form-group has-error">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group input-icon right">
                                                                        <span class="input-group-append">
                                                                            <span class="input-group-text"><i class="livicon" data-name="key" data-size="18" data-c="#EF6F6C" data-hc="#EF6F6C" data-loop="true"></i>
                                                                        </span>
                                                                            </span>
                                                ...
                                                <div class="form-group addon_check">
                                                    <div class="row">
                                                        <label class="col-md-2 control-label">Checkbox right</label>
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><input type="checkbox" class="square-blue"></span></div>
                                                                <input type="text" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control">
                                                                <div class="input-group-append ">
                                                                <span class="input-group-text check_box"><input type="checkbox" class="square-blue">
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group radio_right">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text check_box"><input type="radio" class="radio-blue"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
