...
@section('header_styles')
    ...
    {{--<link href="{{ asset('assets/vendors/autogrow/css/demo.css') }}" rel="stylesheet" />--}}
    <style>
        .span4{
                ...
                <div class="card panel-default my-3">
                    ...
                    <div class="card-body auto_block">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <textarea placeholder="Write something here..." data-autogrow class="form-control resize_vertical autogrow_area" rows="3" cols="80" id="grow"></textarea>
                                </div>
                            </div>
                            <!-- /.input group -->
                        </div>
