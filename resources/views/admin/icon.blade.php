                            ...
                            <div class='col-12'>
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        <li class=" nav-item ">
                                            <a href="#fa-icons" data-toggle="tab" class="nav-link active">Font Awesome</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#ionicons" data-toggle="tab" class="nav-link">Ionicons</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#lineicons" data-toggle="tab" class="nav-link">Simple Line Icons</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-pane" id="ionicons">
                                        <div class="row mar-40 ">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-left">
                                                <span class="nav">
                                                    <i class="ion-ionic" id="ion_icon" data-pack="default" data-tags="badass, framework, sexy, hawt"></i>
                                                    &nbsp; ion-ionic
                                                </span>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-left">
