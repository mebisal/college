...
<section class="content-header">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card panel-primary tabtop">
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="tab_3" style="padding:10px;" role="tabpanel">
                                                <img src="{{ asset('assets/img/cropping-image.jpg') }}" class="img-fluid" id="target3" alt="[Jcrop Example]" />
                                                <div id="preview-pane">
                                            ...
                                            <div class="tab-pane fade" id="tab_4" style="padding:10px;" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <img src="{{ asset('assets/img/cropping-image.jpg') }}" class="img-fluid"  width="595px" id="target4" alt="[Jcrop Example]" />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="span3" id="interface" style="width:220px;">
                                                            <label class="checkbox dir_txt">
                                            ...
                                            <div class="tab-pane fade" id="tab_5" style="padding:10px;" role="tabpanel">
                                                <div class="row">
                                                <div class="col-md-8">
                                                    <img src="{{ asset('assets/img/cropping-image2.png') }}" width="595px" height="400%" class="img-fluid" id="target5" alt="[Jcrop Example]" />
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="tab-pane fade" id="tab_6" style="padding:10px;" role="tabpanel">
                                                <div class="row">
                                                <div class="col-md-8">
                                                    <img src="{{ asset('assets/img/cropping-image.jpg') }}" class="img-fluid" width="600px" id="target6" alt="[Jcrop Example]" />
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="tab-pane fade" id="tab_8" style="padding:10px;" role="tabpanel">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                    <img src="{{ asset('assets/img/cropping-image.jpg') }}" width="600px" class="img-fluid" id="cropbox" />
                                                </div>
