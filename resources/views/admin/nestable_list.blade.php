...
<section class="content">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                ...
                <div class="card panel-info margin_top1">
                    <div class="card-heading">
                        <h3 class="card-title">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                ...
                <div class="card panel-warning margin_top1">
                    <div class="card-heading">
                        <h3 class="card-title">
...
{{--<script src="{{ asset('assets/js/pages/jquery-ui.min.js') }}" ></script>--}}
    ...
    <script src="{{ asset('assets/vendors/nestable-list/js/jquery.nestable.js') }}" ></script>
    <script src="{{ asset('assets/vendors/html5sortable/js/html.sortable.js') }}" ></script>
