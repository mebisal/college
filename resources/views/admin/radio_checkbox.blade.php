                ...
                <div class="card panel-success">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <span class="animate_rtl padng_8"><input type="checkbox" class="js-switch" checked/> Small &nbsp;</span>
                            <span class="animate_rtl padng_4"><input type="checkbox" class="js-switch2" checked/> Medium &nbsp;</span>
                            <span class="animate_rtl"> <input type="checkbox" class="js-switch3" checked/> Big </span>
                        </div>
                        <div class="form-group">
                            <div class="color margin_top">
                ...
                <div class="card-body">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="form-check abc-checkbox abc-checkbox-primary">
                                <input class="form-check-input" id="singleCheckbox1" type="checkbox">
                                <label class="form-check-label" for="singleCheckbox1">
                                </label>
                            </div>
                            <div class="form-check abc-checkbox abc-checkbox-primary">
                                <input class="form-check-input" id="singleCheckbox2" type="checkbox">
