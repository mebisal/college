                    ...
                    <div id="filter">
                        <div class="block__list block__list_words">
                            <ul id="editable" class="list-unstyled">
                                <li> <span class="addable_list">List1</span><i class="js-remove">✖</i></li>
                                <li><span class="addable_list">List2</span><i class="js-remove">✖</i></li>
                                <li><span class="addable_list">List3</span><i class="js-remove">✖</i></li>
                            </ul>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/sortablejs/js/Sortable.js') }}" type="text/javascript"></script>
