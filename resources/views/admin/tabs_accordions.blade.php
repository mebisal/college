                                    ...
                                    <div class="card panel-default">
                                        <div class="card-heading" role="tab" id="headingOne">
                                            <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                <h4 class="card-title color1_accordians">Accordion1</h4>
                                            </a>
                                        </div>
                                    ...
                                    <div class="card panel-default my-3">
                                        <div class="card-heading" role="tab" id="headingTwo">
                                            <a data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                <h4 class="card-title color1_accordians">
                                                    Accordion2
                                                </h4>
                                            </a>
                                        </div>
                                    ...
                                    <div class="card panel-default my-3">
                                        <div class="card-heading" role="tab" id="headingThree">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                <h4 class="card-title color1_accordians"> Accordion3</h4>
                                            </a>
                                        </div>
                                ...
                                <div class="tab-content faq-cat-content">
                                    <div class="tab-pane  show active in fade" id="faq-cat-1">
                                        <div  id="accordion-cat-1">
                                            <div class="card panel-default panel-faq">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 pop d-block d-sm-none d-md-none d-lg-none">
                                        ...
                                        <p class="text-center"><button type="button" class="btn btn-default text-center" title="Popover title" data-container="body" data-toggle="popover" data-placement="left" data-content="Popover on left">Popover on left</button></p>
                                    </div>
                                    <div class="po-markup">
                                        <br>
