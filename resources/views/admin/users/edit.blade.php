                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab2" disabled="disabled">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="bio" class="col-sm-2 control-label dir_txt">Bio <small>(brief intro) *</small></label>
                                                <div class="col-sm-10">
                                        ...
                                        <div class="form-group required">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    {{--@if($users_count==1 && $user_role_id==2)--}}
                                                        {{--<select class="form-control required"  title="Select group..." name="groups[]"--}}
                                                                {{--id="groups" disabled="disabled">--}}
                                                            {{--<option value="">Select</option>--}}
                                                            {{--@foreach($roles as $role)--}}
                                                                {{--@if($user->id==1)--}}
                                                                    {{--<option value="{!! $role->id !!}" {{ (array_key_exists($role->id, $userRoles) ? ' selected="selected"' : 'disabled') }}>{{ $role->name }}</option>--}}
                                                                {{--@else--}}
