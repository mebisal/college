        ...
        <div class="row">
            <div class="col-md-12 col-lg-6 col-12">
                ...
                <div class="card panel-info my-3">
                    ...
                    <div class="card-body">
                        <form method="get" name="frmOnline" id='form_validation' onsubmit="return Validation()"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="display_name" id="txtAddress1" class="form-control input-md"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="display_name1" id="txtAddress2" class="form-control input-md"
                        ...
                        <form method="post" id="passwordForm">
                            ...
                            <div class="row my-3">
                                <div class="col-sm-6 col-lg-6 col-12">
                                    <span id="8char" class="fa fa-remove color-pwd"></span><span  class="fnt-14" id="chars">8 Characters Long</span>
                                    <br>
                                    <span id="ucase" class="fa fa-remove color-pwd"></span><span  class="fnt-14"> One Uppercase Letter</span>
                                </div>
                                <div class="col-sm-6 col-lg-6 col-12">
                                    <span id="lcase" class="fa fa-remove color-pwd"></span> <span  class="fnt-14">One Lowercase Letter</span>
                                    <br>
                                    <span id="num" class="fa fa-remove color-pwd"></span><span  class="fnt-14"> One Number</span>
                                </div>
                            </div>
                            ...
                            <div class="row my-2">
                                <div class="col-sm-12 col-lg-12 col-12">
                                    <span id="pwmatch" class="fa fa-remove color-pwd"></span> <span  class="fnt-14">Passwords Match</span>
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" name="display_name" id="display_name"
                                                                   ...
                                                                   tabindex="3" data-error="Username must be enetered" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9 col-md-9 col-lg-9 pl-lg-5">
                                        <div class="radio" style="padding-left:0;">
                                            <label>
                                                <input type="radio" class="custom-radio" name="gender" value="other"/>&nbsp;
                                                Other
                                            </label>
                                        </div>
                                        <div class="radio " style="padding-left:0;">
                                        ...
                                        <div class="radio" style="padding-left:0;">
                                            <label>
                                                <input type="radio" class="custom-radio" name="gender" value="female"/>&nbsp;
                                                Female
                                            </label>
                                        </div>
                                    </div>
