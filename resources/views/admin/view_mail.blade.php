                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4">
                        <div class="bg-white">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ URL::to('admin/draft') }}" class="dir_set">
                                        ...
                                        <td colspan="3" class="images">
                                            ...
                                            <div class="col-md-6 col-lg-3 col-sm-6 col-8">
                                                ...
                                                <div class=" nopadmar">
                                                    <br>
                                                    <div class="row">
                                                    <div class="col-md-3 col-sm-3 col-lg-3 col-6 btn_view">
                                                        <button type="button" class="btn btn-success btn-sm ">View</button>
                                                    </div>
                                                    <div class="col-md-6 col-sm-3 col-lg-6 col-4 margin_left">
                                                        <button type="button" class="btn btn-success btn-sm btn_load">Download</button>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
