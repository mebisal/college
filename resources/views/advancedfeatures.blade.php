...
@section('top')
    <div class="breadcum">
        <div class="container">
            ...
            <div class="float-right d-none d-lg-block d-sm-block d-md-block breadcrum_adjust">
                <i class="livicon icon3" data-name="rocket" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i>Advanced Features
            </div>
            <div class="float-right  d-lg-none d-sm-none d-md-none breadcrum_adjust">
    ...
    <div class="container advfeatures">
        ...
        <div class="row advanced">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                <h3 class="margin_top1">Buttons</h3>
                <button type="button" class="btn btn-responsive button-alignment btn-secondary" data-toggle="button">Submit</button>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                <h3 class="margin_top1">Switches</h3>
        ...
        <h3 class="padng-15 margin_top1">Tab Panels</h3>
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-2 tab_pnl1">
                <div class="bs-example">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="">
                            <a class="nav-link disabled" id="contact-tab" data-toggle="tab" href="#" role="tab" aria-controls="contact" aria-selected="false" style="cursor:not-allowed;">Disabled</a>
                        </li>
                    </ul>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-2 tab_pnl">
                                ...
                                <div id="accordion">
                                    ...
                                    <div class="card my-2">
                                        <div class="card-heading" id="headingTwo">
                                            <h4 class="card-title">
                                                <a data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseOne"   class="text-success" >
                                ...
                                <div  id="accordion1">
                                    <div class="card">
                                        <div class="card-heading" id="headingThree">
                                            <h4 class="card-title">
                                                    <a data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="text-success" >
                                                    <span class=" fa fa-minus"></span>
                                                    <span class="crsr">Tab2-1</span></a>
                                                </h4>
                                        </div>
                                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordion1">
                                            <div class="card-body">
                                                <p>In 1972 a crack commando unit was sent to prison by a military court for a crime they didn't commit. These men promptly escaped from.
                                                </p>
                                            </div>
        ...
        <!-- Panel Section Start -->
        <h3 style="margin-left: 13px;padding-right: 15px">Panels</h3>
        <div class="row">
            <div class="col-md-6 my-2">
                <div class="card panel-primary">
                    <div class="card-heading">
                        <h4 class="card-title">Blue Header Panel</h4>
            ...
            <div class="col-md-6 my-2">
                <div class="card panel-success">
                    <div class="card-heading">
                        <h4 class="card-title">Green Header Panel</h4>
                        <span class="float-right clickable">
                                <i class="fa fa-chevron-up"></i>
                            </span>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 my-2">
                <div class="card panel-danger">
                    <div class="card-heading">
                        <h4 class="card-title">Red Header Panel</h4>
                        <span class="float-right clickable">
                                <i class="fa fa-chevron-up"></i>
                            </span>
                    </div>
            ...
            <div class="col-md-6 my-2">
                <div class="card panel-warning">
                    <div class="card-heading">
                        <h4 class="card-title">Orange Header Panel</h4>
                        <span class="float-right clickable">
                                <i class="fa fa-chevron-up"></i>
                            </span>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 tooltips mb-2">
                <h3 class="margin_top1">Tool Tips</h3>
                <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                    Tooltip on top
                </button>
                <button type="button" class="btn btn-secondary" id ="right" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
                    Tooltip on right
                </button>
            ...
            <div class="col-md-6 pop d-none d-sm-block mb-2">
                <h3 class="margin_top1">Popover</h3>
                    <button type="button" class="btn btn-secondary" title="Popover title" data-container="body" data-toggle="popover" data-placement="left" data-content="Some content in Popover on left">Popover on left</button>
            ...
            <div class="col-md-6 pop d-block d-sm-none d-md-none d-lg-none">
                <h3>Popover</h3>
                <button type="button" class="btn btn-warning" title="Popover title" data-container="body" data-toggle="popover" data-placement="right" data-content=" Popover on right" style="margin-bottom:10px;margin-left:10px;">Popover on right</button>
                <button type="button" class="btn btn-primary" title="Popover title" data-container="body" data-toggle="popover" data-placement="top" data-content=" Popover on top" style="margin-bottom:10px;margin-left:10px;">Popover on top</button>
                <button type="button" class="btn btn-success" title="Popover title" data-container="body" data-toggle="popover" data-placement="bottom" data-content=" Popover on bottom" style="margin-bottom:10px;margin-left:10px;">Popover on bottom</button>
                <button type="button" class="btn btn-secondary" title="Popover title" data-container="body" data-toggle="popover" data-placement="left" data-content="Popover on left" style="margin-bottom:10px;margin-left:10px;">Popover on left</button>
            </div>
            <!-- Popover End -->
        </div>
    ...
    <script>
        $(document).ready(function() {
            $("#right").hover(function () {
                if ($('#right').attr('aria-describedby') !== undefined) {
                     $a=$('#right').attr('aria-describedby');
                     var b=("#"+ $a);
                    $(this).closest('.bs-tooltip-right').css("padding", "0px !important")
                }
            });
        });
    </script>
