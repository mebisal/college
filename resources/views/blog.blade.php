                ...
                <div class="ml-auto col-md-4 col-lg-4 col-12">
                                ...
                                <div class="tab-pane  fade show active" id="tab_default_1">
                                    <div class="media">
                                        <div class="media-left tab col-sm-6 col-md-12 col-12">
                                            <a href="#">
                                                <img class="media-object img-fluid" src="{{ asset('assets/images/img_3.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left tab col-sm-6 col-md-12 col-xs-12">
                                            <a href="#">
                                                <img class="media-object img-fluid" src="{{ asset('assets/images/img_5.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tab_default_2">
                                    <div class="media">
                                        <div class="media-left media-middle tab col-sm-12 col-12">
                                            <a href="#">
                                                <img class="media-object img-fluid my-2" src="{{ asset('assets/images/img_5.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left tab col-sm-6 col-md-12 col-12">
                                            <a href="#">
                                                <img class="media-object img-fluid my-2" src="{{ asset('assets/images/img_3.jpg') }}" alt="image">
                                            </a>
                                        </div>
                                    </div>
                                    <h4 class="text-primary">Jelly-o sesame snaps</h4>
                    ...
                    <div class="the-box recent">
                        ...
                        <!--<ul class="media-list media-xs media-dotted">-->
                            <!--<li class="media">-->
                                <!--<a class="float-left" href="#">-->
                                    <!--<img src="{{ asset('assets/images/authors/avatar.jpg') }}" class="rounded-circle img-fluid pull-left" alt="riot">-->
                                <!--</a>-->
                        ...
                        <div class="media">
                            ...
                            <div class="media">
                                <a class="float-left" href="#">
                                <img src="{{ asset('assets/images/authors/avatar1.jpg') }}" class="rounded-circle img-fluid pull-left" alt="riot">
                                </a>
                                <div class="media-body ml-3">
                                    <h4 class="media-heading primary">
                            ...
                            <div class="media">
                                <a class="float-left" href="#">
                                <img src="{{ asset('assets/images/authors/avatar5.jpg') }}" class="rounded-circle img-fluid pull-left" alt="riot">
                                </a>
                                <div class="media-body ml-3">
                                    <h4 class="media-heading primary">
