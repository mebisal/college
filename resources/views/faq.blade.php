...
@section('top')
    <div class="breadcum">
        <div class="container">
            <div class="row">
                <div class="col-12">
            <ol class="breadcrumb faq_brdcmb">
                <li>
                ...
                <div class="card card_collapse">
                    <div class="card-body">
                        <div class="panel-group panel-accordion faq-accordion">
                            <div id="faq">
                                <div class="mix category-1 col-lg-12 card1 card" data-value="1">
                                ...
                                <div class="mix category-1 col-lg-12 card1 card" data-value="2">
                                ...
                                <div class="mix category-1 col-lg-12 card1 card" data-value="3">
                                ...
                                <div class="mix category-2 col-lg-12 card1 card" data-value="4">
                                ...
                                <div class="mix category-1 col-lg-12 card1 card" data-value="5">
                                ...
                                <div class="mix category-2 col-lg-12 card1 card" data-value="6">
                                ...
                                <div class="mix category-3 col-lg-12 card1 card" data-value="7">
                                ...
                                <div class="mix category-3 col-lg-12 card1 card" data-value="8">
                                ...
                                <div class="mix category-2 col-lg-12 card1 card" data-value="9">
                                    <div class="card-heading" id="headingNine">
                                        <h4 class="card-title">
