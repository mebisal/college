...
<div class="container">
    <div class="row">
        <div class="box animation flipInX">
            ...
            <form action="{{ route('forgot-password-confirm',compact(['userId','passwordResetCode'])) }}" class="omb_loginForm pwd_validation" id="forgot_confirm"  autocomplete="off" method="POST">
                {!! Form::token() !!}
