...
@section('content')
    ...
    <div class="container my-3">
        <!-- Grid Section Start -->
        <h2 class="grid_hedng">Grid System</h2>
        <div class="row">
            <div class="col-12">
            <form class="grid">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-12 col-sm-12 my-3 ">
                <div class="card">
                    <div class="card-heading card_primary">
                        <h3 class="card-title ">
                    ...
                    <div class="card-body" id="slim1">
                        ...
                        <h3> Grid</h3>
                        <div class="row">
                            <div class="col-5  bar-primary">
                                <p class="text-center">.col-5</p>
                            </div>
                            <div class="col-4  bar-success">
                                <p class="text-center">.col-4</p>
                            </div>
                            <div class="col-3  bar-danger">
                        ...
                        <div class="row">
                            <div class="col-lg-4 bar-primary">
                                <p class="text-center">.col-lg-4</p>
                            </div>
