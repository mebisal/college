    ...
    <div class="row top_set">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 wow bounceInLeft" data-wow-duration="3.5s">
            <div class="box">
                ...
                <div class="info">
                    <h3 class="success text-center setng_mt">Responsive</h3>
        ...
        <div class="col-sm-6 col-md-6  col-lg-3 col-12 wow bounceInDown" data-wow-duration="3s" data-wow-delay="0.4s">
            ...
            <div class="box">
                ...
                <div class="info">
                    <h3 class="primary text-center setng_mt">Easy to Use</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti atque, tenetur quam aspernatur
                        corporis at explicabo nulla dolore necessitatibus doloremque exercitationem sequi dolorem
                        architecto perferendis quas aperiam debitis dolor soluta!.</p>
                    <div class="text-right primary"><a href="#">Read more</a>
        ...
        <div class="col-sm-6 col-md-6  col-lg-3 col-12 wow bounceInUp" data-wow-duration="3s" data-wow-delay="0.8s">
            <div class="box">
                ...
                <div class="info">
                    <h3 class="warning text-center setng_mt">Clean Design</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti atque, tenetur quam aspernatur
                        corporis at explicabo nulla dolore necessitatibus doloremque exercitationem sequi dolorem
                        architecto perferendis quas aperiam debitis dolor soluta!</p>
                    <div class="text-right primary"><a href="#">Read more</a>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 col-12  wow bounceInRight" data-wow-duration="5s" data-wow-delay="1.2s">
            <div class="box">
                ...
                <div class="info">
                    <h3 class="yellow text-center setng_mt">20+ Pages</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti atque, tenetur quam aspernatur
                        corporis at explicabo nulla dolore necessitatibus doloremque exercitationem sequi dolorem
                        architecto perferendis quas aperiam debitis dolor soluta!</p>
                    <div class="text-right primary"><a href="#">Read more</a>
                    ...
                    <div class="card-header header_card" id="headingOne">
                        <h5 class="mb-0">
                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne"
                                ...
                                <span class="success font_set">Why Choose Us</span>
                            </button>
                        </h5>
                    </div>
...
<div class="container">
    ...
    <div class="row text-center">
        <div class="col-md-6 col-sm-6 col-12 col-lg-3 profile wow fadeInLeft" data-wow-duration="3s"
            ...
            <div class="thumbnail bg-white">
                <img src="{{ asset('assets/images/img_3.jpg') }}" alt="team-image" class="img-fluid">
                <div class="caption">
                    <b>John Doe</b>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-12 profile wow fadeInDown" data-wow-duration="3s"
             data-wow-delay="0.5s">
            <div class="thumbnail bg-white">
                <img src="{{ asset('assets/images/img_4.jpg') }}" alt="team-image" class="img-fluid">
                <div class="caption">
                    <b>Audrey Sheldon</b>
    ...
    <div class="row">
        ...
        <div class="col-md-4  col-lg-4 col-12 wow bounceInLeft" data-wow-duration="3s">
            <div class="author">
                <img src="{{ asset('assets/images/authors/avatar3.jpg') }}" alt="avatar3"
                     class="img-fluid rounded-circle pull-left animate_rtl">
                <p class="text-right">
                    Tonny Jakson
                    <br>
        ...
        <div class="col-md-4  col-12 col-lg-4 wow bounceIn" data-wow-duration="3s">
            <div class="author">
                <img src="{{ asset('assets/images/authors/avatar2.jpg') }}" alt="avatar2"
                     class="img-fluid rounded-circle pull-left animate_rtl">
                <p class="text-right">
                    Tonny Jakson
                    <br>
        ...
        <div class="col-md-4  col-lg-4 col-12 wow bounceInRight" data-wow-duration="3s">
            <div class="author">
                <img src="{{ asset('assets/images/authors/avatar4.jpg') }}" alt="avatar4"
                     class="img-fluid rounded-circle pull-left animate_rtl">
                <p class="text-right">
                    Tonny Jakson
                    <br>
    ...
    <div class="row features">
        ...
        <div class="col-md-4 col-sm-4 col-lg-4 col-12 wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s">
            <div>
                <a href="#"><i class="livicon animate_rtl" data-name="checked-on" data-size="22" data-loop="true" data-c="#25a3d8"
                               data-hc="#25a3d8"></i></a>
            ...
            <div>
                <a href="#"> <i class="livicon animate_rtl" data-name="checked-on" data-size="22" data-loop="true" data-c="#ef8424 "
                                data-hc="#ef8424 "></i>
                </a>
                <h4>Html 5</h4>
                <p>
        ...
        <div class="col-md-4 col-sm-4  col-lg-4  col-12 wow fadeInDown" data-wow-duration="3s" data-wow-delay="0.5s">
            <div>
                <a href="#"> <i class="livicon animate_rtl" data-name="checked-on" data-size="22" data-loop="true" data-c="#01bc8c"
                                data-hc="#01bc8c"></i>
                </a>
                <h4>Unique Design</h4>
                <p>
            ...
            <div>
                <a href="#"> <i class="livicon animate_rtl" data-name="checked-on" data-size="22" data-loop="true" data-c="#1360b3 "
                                data-hc="#1360b3 "></i>
                </a>
                <h4>Css</h4>
                <p>
        ...
        <div class="col-md-4 col-sm-4 col-lg-4 col-12 wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s">
            <div>
                <a href="#"> <i class="livicon animate_rtl" data-name="checked-on" data-size="22" data-loop="true" data-c="#FFD43C"
                                data-hc="#FFD43C"></i>
                </a>
                <h4>Clean Design</h4>
                <p>
            ...
            <div>
                <a href="#"> <i class="livicon animate_rtl" data-name="checked-on" data-size="22" data-loop="true" data-c="#91d659 "
                                data-hc="#91d659 "></i>
                </a>
                <h4>Bootstrap</h4>
                <p>
