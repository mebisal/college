...
@section('content')
    ...
    <div class="container my-3 products">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/htc.jpg') }}" class="img-fluid" alt="htc image"></a>
                    <br/>
                    <h5 class="text-primary dir_txt mt-4 mb-2">HTC Desire 816G Plus - (Blue)</h5>
                    <ul>
                        <li><i class="dir_txt livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Android v4.4.2 (KitKat)</li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/sony.jpg') }}" class="img-fluid" alt="sony image"></a>
                    <br/>
                    <h5 class="text-primary dir_txt mt-4 mb-2">Sony Xperia C3 - (Black)</h5>
                    <ul>
                        <li><i class="dir_txt livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Android v4.4.2 (KitKat)</li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/karbon.jpg') }}" class="img-fluid" alt="karbon image"></a>
                    <br/>
                    <h5 class="text-primary dir_txt mt-4 mb-2">Karbonn Titanium Octane Plus</h5>
                    <ul>
                        <li><i class="dir_txt livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/nokia.jpg') }}" class="img-fluid" alt="nokia image"></a>
                    <br/>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/samsung balck.jpg') }}" class="img-fluid" alt="samsung black image"></a>
                    <br/>
                    <h5 class="text-primary dir_txt mt-4 mb-2">Samsung Galaxy S6 32 GB - (Black)</h5>
                    <ul>
                        <li><i class="dir_txt livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class=" thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/samsung.jpg') }}" class="img-fluid" alt="samsung image"></a>
                    <br/>
                    <h5 class="text-primary dir_txt mt-4 mb-2">Samsung Galaxy S6 64 GB - (White)</h5>
                    <ul>
                        <li><i class="livicon dir_txt" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Android OS, v5.0.2 (Lollipop)</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> 16 MP, 3456 x 4608 pixels</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> 5.1 inches </li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Nano Sim</li>
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Quad 2.1GHz + Quad </li>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/saree.jpg') }}" class="img-fluid" alt="saree image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/saree2.jpg') }}" class="img-fluid" alt="saree2 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/saree3.jpg') }}" class="img-fluid" alt="saree3 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/saree4.jpg') }}" class="img-fluid" alt="saree4 image"></a>
                    <br/>
                    ...
                    <ul>
                        ...
                        <li><i class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Pattern - Printed</li>
                        <li><i class="livicon dir_txt" data-name="check" data-size="18" data-loop="true" data-c="#787878" data-hc="787878"></i> Length(in mtr) - 6.3 Meter </li>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/men.jpg') }}" class="img-fluid" alt="men image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/men2.jpg') }}" class="img-fluid" alt="men2 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="0.9s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/men3.jpg') }}" class="img-fluid" alt="men3 image"></a>
                    <br/>
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 wow flipInX" data-wow-duration="3s" data-wow-delay="1.4s">
                <div class="thumbnail text-center">
                    <a href="{{ URL::to('single_product') }}"><img src="{{ asset('assets/images/cart/men4.jpg') }}" class="img-fluid" alt="men4 image"></a>
                    <br/>
