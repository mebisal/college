        ...
        <div class="box animation flipInX font_size">
            ...
            <form action="{{ route('register') }}" method="POST" id="reg_form">
                ...
                <div class="form-group {{ $errors->first('first_name', 'has-error') }}">
                    ...
                    <input type="text" class="form-control" id="first_name1" name="first_name" placeholder="First Name"
                           value="{!! old('first_name') !!}" >
                    {!! $errors->first('first_name', '<span class="help-block">:message</span>') !!}
                </div>
                <div class="form-group {{ $errors->first('last_name', 'has-error') }}">
                    <label class="sr-only"> Last Name</label>
                    <input type="text" class="form-control" id="last_name1" name="last_name" placeholder="Last Name"
                           value="{!! old('last_name') !!}" >
