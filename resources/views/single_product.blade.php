...
@section('content')
    ...
    <div class="container my-3 single_prd">
        <!--item view start-->
        <div class="row">
            <!--<div class="mart10">-->
                <!--product view-->
                <div class="col-md-4 col-lg-4 col-sm-6 col-12">
                    <div class="row">
                        <div class="product_wrapper">
                            <img id="zoom_09" src="{{ asset('assets/images/cart/small/1.jpg') }}" data-zoom-image="{{ asset('assets/images/cart/big/1.jpg') }}" class="img-fluid" />
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="row">
            <div class="flip-3d">
                <figure>
                    <img src="{{ asset('assets/images/cart/default/saree1.jpg') }}" alt="product image" class="img-fluid">
                    <figcaption>
                        <h4 class="text-white set_mrtop">Floral Printed Saree</h4>
                        <ul class="text-white">
            ...
            <div class="flip-3d">
                <figure>
                    <img src="{{ asset('assets/images/cart/default/shirt.jpg') }}" alt="product image" class="img-fluid">
                    <figcaption>
                        <h4 class="text-white set_mrtop">Atelier Check Shirt</h4>
                        <ul class="text-white">
                            <li>Product -Men's Club Wear</li>
                            <li>Care - Machine/Hand Wash</li>
                        </ul>
                        <h4 class="text-white pdng_none"><del class="text-danger">Rs. 1999.00</del> Rs. 1499.00</h4>
                    </figcaption>
                </figure>
            </div>
            <div class="flip-3d">
                <figure>
                    <img src="{{ asset('assets/images/cart/default/sony.jpg') }}" alt="product image" class="img-fluid">
                    <figcaption>
                        <h4 class="text-white set_mrtop">Sony Xperia C3 - (Black)</h4>
                        <ul class="text-white">
            ...
            <div class="flip-3d">
                <figure>
                    <img src="{{ asset('assets/images/cart/default/samsung.jpg') }}" alt="product image" class="img-fluid">
                    <figcaption>
                        <h4 class="text-white set_mrtop">Samsung Galaxy S6 64 GB - (White)</h4>
                        <ul class="text-white">
                            <li>Android v4.4.2 (KitKat)</li>
                            <li>Quad-core 1.2 GHz</li>
                        </ul>
