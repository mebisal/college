...
const paths = {
    ...
    // 'formBuilder': vendors + 'form-builder/js/lib/',// not woking
...
mix.copy(paths.autogrow + 'css/demo.css',  destVendors + 'autogrow/css');
// //
// trumbowyg
...
// rtl editor2
mix.copy( srcCss + 'bootstrap-wysihtml5-rtl.css', destCss);
...
//copy rtl css to public
mix.sass( srcCss + 'rtl.scss', destCss );
